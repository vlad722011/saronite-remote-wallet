            ...
            <div id="main_page" style="display:block">
                ...
                <div class="row">
                    <div class="col-sm-12" style="background: transparent; text-align: center;">
                        <button id="btn_cancel" type="button" class="btn btn-danger center" onclick="close_dialog()"><i class="fa fa-close"></i> Close</button>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input id="wallet_address" type="text" class="form-control address-box" style="color:#c7254e;" readonly="readonly" value="SsSs..."/>
                        </div>
                        <div class="form-group">
